      ...
      <Container maxW="container.md">
        <VStack spacing={5}>
          ...
          <FormControl id="shippingInfo" isRequired>
            <FormLabel color="white">Shipping Information</FormLabel>
          ...
          <FormControl id="materialDetails" isRequired>
            <FormLabel color="white">Material Details</FormLabel>
            <Input name="materialDetails" value={formData.materialDetails} onChange={handleInputChange} placeholder="Describe the material and specs" color="white" />
          </FormControl>
          <FormControl id="desiredSize" isRequired>
            <FormLabel color="white">Desired Size</FormLabel>
            <Input name="desiredSize" value={formData.desiredSize} onChange={handleInputChange} placeholder="Enter the desired size" color="white" />
          </FormControl>
          <FormControl id="sampleLocation" isRequired>
            <FormLabel color="white">Sample Location</FormLabel>
            <Input name="sampleLocation" value={formData.sampleLocation} onChange={handleInputChange} placeholder="Describe the sample location" color="white" />
          </FormControl>
